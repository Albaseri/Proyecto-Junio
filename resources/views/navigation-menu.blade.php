        ...
        <div class="flex justify-between h-16">
            ...
            @else
                @if (Route::has('login'))
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="font-semibold text-white hover:text-cyan-200 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Inicio</a>
                        @else
                            <a href="{{ route('login') }}" class="font-semibold text-white hover:bg-blue-500 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 py-2 px-2 border-2 rounded-full border-cyan-500">Iniciar Sesión</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="ml-4 font-semibold text-white hover:bg-blue-500 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 py-2 px-2 border-2 rounded-full border-cyan-500">Registrarse</a>
                            @endif
                        @endauth
                    </div>
                @endif
