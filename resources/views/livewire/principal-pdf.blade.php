<x-propios.principal>
    <h1 class="text-black font-bold text-center text-2xl  my-4">Gestionar PDFs</h1>
                ...
                @foreach ($pdfs as $item)
                    <tr class="bg-white border-b hover:bg-cyan-50">
                        ...
                        <td class="px-6 py-4 text-center ">
                            <form action="{{ route('pdfs.destroy', $item->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('pdfs.edit', $item->id) }}">
