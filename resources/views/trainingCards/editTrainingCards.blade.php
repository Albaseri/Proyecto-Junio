        ...
        <x-propios.principal>
            <div class="w-1/2 mx-auto p-6 rounded-xl shadow-xl text-black bg-gray-100 dark:text-black ">
                <form method="POST" action="{{ route('trainingCards.edit', $trainingCard) }}" enctype="multipart/form-data">
                    ...
                    @method('put')
                    <div class="mb-5">
                        <h1 class="mb-5 text-black text-center font-bold">ACTUALIZAR TRAINING CARD</h1>
                    ...
                    <div class="mb-5">
                        <label for="descripcion"
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:cyan-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-cyan-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-cyan-500 dark:focus:border-blue-500"
                            name="descripcion">{{ old('descripcion', $trainingCard->descripcion) }}</textarea>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="n_repeticiones" value="{{ @old('n_repeticiones',$trainingCard->n_repeticiones) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:cyan-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-cyan-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-cyan-500 dark:focus:border-blue-500"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="n_series" value="{{ @old('n_series',$trainingCard->n_series) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:cyan-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-cyan-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-cyan-500 dark:focus:border-blue-500"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="url" id="url_youtube" value="{{ @old('url_youtube',$trainingCard->url_youtube) }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:purple-cyan-500 block w-full p-2.5 dark:bg-white-700 dark:border-cyan-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-cyan-500 dark:focus:border-blue-500"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center me-4">
                            <input id="VISIBLE" name="estado" type="radio" value="VISIBLE"   @checked($trainingCard->estado == 'VISIBLE')
                        ...
                        <div class="flex items-center me-4">
                            <input id="NO VISIBLE" name="estado" type="radio" value="NO VISIBLE" @checked($trainingCard->estado == 'NO VISIBLE')
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-xl focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2  dark:border-gray-600">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="w-full mt-2 px-2 md:w-3/8">
                            <img src="{{ Storage::url($trainingCard->imagen) }}"
