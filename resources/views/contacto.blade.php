            ...
            <div
                ...
                <div class="flex flex-col space-y-8 justify-between">
                    <div>
                        ...
                        <p class="pt-2 text-indigo-100 text-sm">¿Tienes alguna pregunta sobre mis servicios de
                    ...
                    <div class="flex flex-col space-y-6">
                        <div class="inline-flex space-x-2 items-center w-60">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                                fill="none" stroke="#a5b4fc" stroke-width="2" stroke-linecap="round"
                        ...
                        <form method="POST" action="{{ route('correo.enviar') }}" class="flex flex-col space-y-4">
                            ...
                            <div>
                                ...
                                <input type='text' name='nombre' placeholder='Nombre'
                                    value="{{ old('nombre') }}"
                                    class="ring-1 ring-gray-300 mt-2 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-cyan-300"
                                    class="ring-1 ring-gray-300 mt-2 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-cyan-300">
                                @error('nombre')
                            ...
                            <div>
                                ...
                                <textarea name='mensaje' placeholder='Mensaje' id="contenido" rows="4"
                                    class="ring-1 ring-gray-300 mt-2 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-indigo-300"></textarea>
                            </div>
                            <button type='submit'
                                class="inline-block self-end bg-indigo-600 font-bold rounded-lg px-6 py-4 uppercase text-sm text-white">Enviar
                                Mensaje</button>
                        </form>
                    </div>
                </div>
