            ...
            <div
                ...
                <div class="flex flex-col space-y-8 justify-between">
                    ...
                    <div class="flex flex-col space-y-6">
                        <div class="inline-flex space-x-2 items-center w-60">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                                fill="none" stroke="#8CFBFB" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="www.linkedin.com/in/alba-sedeño-168895114" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <form method="POST" action="{{ route('correo.enviar') }}" class="flex flex-col space-y-4">
                            ...
                            <div>
                                ...
                                <input type='text' name='nombre' placeholder='Nombre'
                                    value="{{ old('nombre') }}"
                                    class=" border-none ring-1 ring-gray-300 mt-2 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-cyan-300"
                                    @error('nombre')
                                ...
                                <div>
                                    ...
                                    <textarea name='mensaje'
                                        placeholder='¡Hola! Quiero obtener más información sobre el Plan Premium y tus rutinas de entrenamiento'
                                        id="contenido" rows="4"
                                        class="border-none ring-1 ring-gray-300 mt-2 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-indigo-300"></textarea>
                                </div>
                                <button type='submit'
                                    class="mt-5 inline-block self-end bg-indigo-600 font-bold rounded-lg px-6 py-4 uppercase text-sm text-white">Enviar
                                    Mensaje</button>
                        </form>
                    </div>
                </div>
