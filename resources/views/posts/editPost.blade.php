<x-app-layout>
    ...
    <div class="min-h-screen bg-gradient-to-br from-cyan-200 to-blue-800 flex justify-center items-center opacity-80">
        <x-propios.principal>
            <div
                class="w-full  max-w-5xl p-0 rounded-xl shadow-xl text-black bg-white bg-opacity-30 dark:text-black mt-5">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <div class="mb-5">
                                ...
                                <label for="titulo"
                                    class="block mb-2 text-md text-black dark:text-black font-bold">Título:</label>
                                </label>
                            ...
                            <div class="mb-5">
                                <label for="categoria"
                                    class="block mb-2 text-md text-black dark:text-black font-bold">Seleccione una
                                    categoría:</label>
                                <select id="category_id"
                                    ...
                                    @foreach ($categorias as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == $post->category_id ? 'selected' : '' }}>{{ $item->nombre }}
                                        </option>
                                    @endforeach
                                </select>
