<x-app-layout>
    <x-propios.principal>
            ...
            <div class="w-full bg-cover bg-center h-32 rounded-2xl"
                ...
                <div class="flex items-center justify-center h-full w-full bg-opacity-50">
                    <div class="text-center">
                        ...
                        <p class="text-black py-1 bg-cyan-100  rounded-lg hover:bg-gray-300 hover:text-gray-800 transition duration-300 border"> {{ $post->category->nombre }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="p-6 sm:container xs:container md:w-2/3 md:max-w-4xl mx-auto text-gray-800 text-lg">
            ...
            <p>
                <span class="font-bold">Última modificación de creación:</span> {{ $post->updated_at->format('d/m/Y h:i:s') }}
            </p>
