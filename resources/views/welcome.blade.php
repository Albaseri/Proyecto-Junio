<x-app-layout>
    ...
    <div class="py-12 bg-gradient-to-r from-blue-500 via-cyan-600 to-blue-900 bg-opacity-20">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden sm:rounded-lg">
                <div class="bg-opacity-10 bg-black">
                    ...
                    <div class=" bg-opacity-40 bg-black relative isolate overflow-hidden py-16 sm:py-24 lg:py-32">
                        <div class="container mx-auto px-6 lg:px-8">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                                <div>
                                    <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">¡Descarga estos
                                        tips gratuitos ya!
                                    </h2>
                                    <p class="mt-5 text-lg leading-8 text-cyan-100">Obtén acceso instantáneo a nuestro
                                        PDF gratuito con una
                                        serie de consejos saludables para mejorar tu bienestar y calidad de vida.</p>
                                    <div class="mt-6">
                                        <a href="#"
                                            class="inline-block rounded-md bg-white px-5 py-3 text-md font-semibold text-blue-500 hover:shadow-sm hover:shadow-blue-500 bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">¡Lo
                                            quiero ya!
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
                        <div class="p-6 rounded-lg shadow-md bg-white bg-opacity-20">
                        ...
                        <div class="p-6 rounded-lg shadow-md bg-white bg-opacity-50">
                            <div class="flex items-center text-white">
                        ...
                        <div class="p-6 rounded-lg shadow-md bg-white bg-opacity-40">
                            <div class="flex items-center text-white">
        ...
        <div class="fixed bottom-8 right-8">
            <a href="https://api.whatsapp.com/send/?phone=34653412531&text=¡Hola! Estoy interesado/a en saber más sobre tu plan de entrenamiento ¡Necesito ponerme en forma! Muchas gracias de antemano.🏋🏼‍♀️🙌🏼&type=phone_number&app_absent=0"
                ...
                <?xml version="1.0" ?><svg id="Layer_1" style="enable-background:new 0 0 1000 1000;" version="1.1"
