            ...
            <section class="overflow-hidden sm:rounded-lg">
                <div class="bg-opacity-10 bg-black">
                    <div class="p-6 lg:p-8 text-left">
                        <h1 class="mt-8 text-7xl text-white font-semibold text-white-800 " data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    ...
                    <h1 class="text-5xl mt-5 p-5 text-white font-bold">Transforma tu <span class="text-cyan-200 text-4xl font-bold">estilo de vida</span>, no sólo tu cuerpo</h1>
                    ...
                    <section class="mx-auto pt-10 pb-36 px-8 bg-gray-800 bg-opacity-40">
                        <div class="max-w-md mx-auto mb-14 text-center">
                            <h1 class="text-4xl font-semibold text-white mb-6 lg:text-5xl animate__animated animate__bounceIn">
                                ¡Planes de Entrenamiento!
                            </h1>

                        </div>

                        <div class="flex flex-col justify-between items-center lg:flex-row lg:items-start" data-aos="fade-up-left">
                            {{-- Plan Gratuito --}}
                            <div class="w-full flex-1 mt-8 p-8 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:rounded-r-none">
                                <div class="mb-7 pb-7 flex items-center border-b border-gray-300">
                                    <img src="https://res.cloudinary.com/williamsondesign/abstract-1.jpg" alt="Plan Gratuito" class="rounded-3xl w-20 h-20" />
                                    <div class="ml-5">
                                ...
                                <ul class="mb-7 font-medium text-gray-500">
                                    <li class="flex text-lg mb-2">
                                        <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="Check icon" />
                            ...
                            <div class="w-full flex-1 p-8 mt-8 shadow-xl rounded-3xl bg-gradient-to-b from-cyan-700 to-blue-500 text-white sm:w-96 lg:w-full lg:mt-0">
                                <div class="mb-8 pb-8 flex items-center border-b border-black">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <span class="text-3xl font-bold">19 </span><span class="font-medium text-xl">€</span><span class="font-medium">/ usuario</span>
                                    </div>
                                </div>
                            ...
                            <div class="w-full flex-1 mt-8 p-8 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full">
                                ...
                                <ul class="mb-7 font-medium text-gray-500">
                                    <li class="flex text-lg mb-2">
                                        <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="Check icon" />
                                        <span class="ml-3">Mantente atento a nuestras <span class="text-black">novedades</span></span>
                                    </li>
                ...
                <div class="relative bg-black py-20 px-6 font-[sans-serif]">
                    ...
                    <div class="absolute inset-0 bg-cover bg-center bg-black opacity-50" style="background-image: url(https://img.freepik.com/foto-gratis/hombre-fuerte-entrenando-gimnasio_1303-23478.jpg);">
                    </div>
                    <div class="relative container mx-auto text-center">
                        ...
                        <a href="{{ route('contacto.mostrar') }}" class="bg-white text-blue-500 hover:bg-blue-700 hover:text-white py-3 px-8 rounded-full text-lg font-semibold transition duration-300 hover:shadow-lg animate__bounce">
                            ¡Contáctame!
                        </a>
                    </div>
                </div>
        ...
        <footer class=" bg-gradient-to-b from-blue-950  to-blue-800 text-white py-12 px-4 font-sans tracking-wide">
            <div class="text-center">
                ...
                <ul class="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
                    ...
                    <li><a href="https://www.linkedin.com/in/alba-sedeño-168895114" target="_blank" class="text-xl">
                    ...
                    <li><a href="https://www.instagram.com/alba.seri/?igsh=MWpiNmd4MnR6OGJjYw%3D%3D" target="_blank" class="text-xl hover:text-gray-400">
                ...
                <p xmlns:cc="http://creativecommons.org/ns#" class="text-sm flex justify-center items-center">
                    ...
                    <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/?ref=chooser-v1" target="_blank" rel="noopener noreferrer" class="inline-block hover:underline ml-1 flex items-center">
                        <span class="sr-only">CC BY-NC-ND 4.0</span>
                        <img class="h-5 mx-1" src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1" alt="CC icon">
                        <img class="h-5 mx-1" src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1" alt="BY icon">
                        <img class="h-5 mx-1" src="https://mirrors.creativecommons.org/presskit/icons/nc.svg?ref=chooser-v1" alt="NC icon">
                        <img class="h-5 mx-1" src="https://mirrors.creativecommons.org/presskit/icons/nd.svg?ref=chooser-v1" alt="ND icon">
                    </a>
                </p>
